...
**Primary open engineering:** Optional real DM + Langfuse compose recreate; compose `up n8n` fix; **CIP-D**, ATTR-3, and **website chat runtime implementation** after E1.5 capability-matrix review. **E1.0–E1.5 channel / website-chat strategy spec slices are complete (spec-only).**

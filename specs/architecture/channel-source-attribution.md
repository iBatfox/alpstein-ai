...
**Date:** 2026-05-25  
**Depends on:** [webhooks.md](../api/webhooks.md), [normalized-channel-contract.md](normalized-channel-contract.md) (E1.2), [../../docs/architecture/multi-channel-identity-strategy.md](../../docs/architecture/multi-channel-identity-strategy.md) (E1.4), [../../docs/architecture/channel-capability-matrix.md](../../docs/architecture/channel-capability-matrix.md) (E1.5), [database-schema.md](../database/database-schema.md), [prompt-builder-rules.md](prompt-builder-rules.md), [incoming-message-flow.md](../flows/incoming-message-flow.md)

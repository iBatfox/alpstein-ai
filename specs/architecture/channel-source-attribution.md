...
**Date:** 2026-05-25  
**Depends on:** [webhooks.md](../api/webhooks.md), [database-schema.md](../database/database-schema.md), [prompt-builder-rules.md](prompt-builder-rules.md), [incoming-message-flow.md](../flows/incoming-message-flow.md)
